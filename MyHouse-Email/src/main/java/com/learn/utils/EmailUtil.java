...
public class EmailUtil {
    ...
    /**  存放图片的文件夹在项目中的路径  **/
    private static String imgFolderPath = "src\\main\\resources\\email\\img\\";

    /**  存放附件的文件夹在项目中的路径  **/
    private static String fileFolderPath = "src\\main\\resources\\email\\file\\";
    ...
    public static void sendEmail(String mailTo,String mailTittle,String mailText, Integer type) throws Exception {
        ...
        switch (type){
            case 1:
                ...
                break;
            case 2:
                message = createImageMail(session,mailTo,mailTittle,mailText);
                break;
            case 3:
                message = createAttachmentMail(session,mailTo,mailTittle,mailText);
                break;
            case 4:
